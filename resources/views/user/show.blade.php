          ...
          <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <div class="border-t border-gray-400 my-8"></div>
              ...
              @if($product->shop->filename !== null)
                <img src="{{ asset('storage/shops/' . $product->shop->filename )}}" class="mx-auto w-40 h-40 rounded-full object-cover">
              @else
                <img src="">
              @endif
              </div>
              <div class="mb-4 text-center">
                  <button type="button" data-micromodal-trigger="modal-1" href="javascript:;" class=" text-white bg-gray-300 border-0 py-2 px-6 focus:outline-none hover:bg-gray-500 rounded">ショップの詳細を見る</button>
              </div>
      ...
      <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
        <header class="modal__header">
          <h2 class="modal__title " id="modal-1-title">
            <span class="text-xl text-gray-700">{{ $product->shop->name }}</span>
          </h2>
