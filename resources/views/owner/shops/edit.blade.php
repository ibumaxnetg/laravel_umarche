                  ...
                  <form method="POST" action="{{ route('owner.shops.update', ['shop' => $shop->id ]) }}" enctype="multipart/form-data">
                    ...
                    <div class="p-2 w-1/2 mx-auto">
                        <div class="relative flex justify-around">
                            <label><input type="radio" name="is_selling" value="1" @if ($shop->is_selling === 1) { checked } @endif class="mr-2" />販売中</label>
                            <label><input type="radio" name="is_selling" value="0" @if ($shop->is_selling === 0){ checked } @endif class="mr-2" />販売停止中</label>
                         </div>
                    </div>  
