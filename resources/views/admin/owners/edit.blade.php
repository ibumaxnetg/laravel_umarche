                  ...
                  <div class="container px-5 mx-auto">
                    ...
                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                      ...
                      <form method="POST" action="{{ route('admin.owners.update', ['owner' => $owner->id]) }}">
                        ...
                        <div class="p-2 w-1/2 mx-auto">
                          <div class="relative">
                            <label for="shop" class="leading-7 text-sm text-gray-600">オーナー名</label>
                        ...
                        <div class="p-2 w-full flex justify-around mt-4">
                          <button type="button" onclick="location.href='{{ route('admin.owners.index') }}'" class="bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">もどる</button>
